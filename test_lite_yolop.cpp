...
{
  std::string onnx_path = "yolop-640-640.onnx";
  std::string test_img_path = "test_lite_yolop.jpg";
  std::string save_det_path = "test_lite_yolop_det.jpg";
  std::string save_da_path = "test_lite_yolop_da.jpg";
  std::string save_ll_path = "test_lite_yolop_ll.jpg";
  std::string save_merge_path = "test_lite_yolop_merge.jpg";
...
static void test_onnxruntime()
{
  ...
  std::string save_det_path = "test_lite_yolop_det_onnx.jpg";
  std::string save_da_path = "test_lite_yolop_da_onnx.jpg";
  std::string save_ll_path = "test_lite_yolop_ll_onnx.jpg";
  std::string save_merge_path = "test_lite_yolop_merge_onnx.jpg";
...
static void test_mnn()
{
  ...
  std::string test_img_path = "../../../examples/lite/resources/test_lite_yolop.jpg";
  std::string save_det_path = "test_lite_yolop_det_mnn.jpg";
  std::string save_da_path = "test_lite_yolop_da_mnn.jpg";
  std::string save_ll_path = "test_lite_yolop_ll_mnn.jpg";
  std::string save_merge_path = "test_lite_yolop_merge_mnn.jpg";
...
static void test_ncnn()
{
  ...
  std::string test_img_path = "../../../examples/lite/resources/test_lite_yolop.jpg";
  std::string save_det_path = "test_lite_yolop_det_ncnn.jpg";
  std::string save_da_path = "test_lite_yolop_da_ncnn.jpg";
  std::string save_ll_path = "test_lite_yolop_ll_ncnn.jpg";
  std::string save_merge_path = "test_lite_yolop_merge_ncnn.jpg";
...
static void test_tnn()
{
  ...
  std::string test_img_path = "../../../examples/lite/resources/test_lite_yolop.jpg";
  std::string save_det_path = "test_lite_yolop_det_tnn.jpg";
  std::string save_da_path = "test_lite_yolop_da_tnn.jpg";
  std::string save_ll_path = "test_lite_yolop_ll_tnn.jpg";
  std::string save_merge_path = "test_lite_yolop_merge_tnn.jpg";
